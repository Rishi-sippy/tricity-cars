...
export const metadata = {
  title: 'Self Drive Cars in Kharar | Cheap Car Rental',
  description: 'Rent self drive cars in Kharar at cheapest prices. Hatchback, sedan & SUV available.'
}
...
export default function KhararPage() {
  return (
    <>
      ...
      <CitySeoSection city="Kharar" description="Looking for self drive cars in Kharar? We offer affordable, well-maintained cars for city travel, weekend trips and long road journeys with complete freedom." />

      {/* CAR LISTING SECTION */}
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <h2 className="text-2xl font-bold mb-8">Available Self Drive Cars in Kharar</h2>
